            ...
            <div className="w-full max-w-[400px] space-y-6">
                ...
                <div className="flex flex-col items-center gap-2 text-center">
                    <Link href="/" className="flex items-center gap-2 mb-2">
                        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                            <Brain className="h-8 w-8 text-white" />
                        </div>
                    </Link>
                    <span className="font-bold text-3xl tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">SkillXIntell</span>
